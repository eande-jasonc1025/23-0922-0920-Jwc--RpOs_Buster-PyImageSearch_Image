...
if len(corners) > 0:
    ...
    for (markerCorner, markerID) in zip(corners, ids):
        ...
        ###jwc n cv2.line(image, topLeft, topRight, (0, 255, 0), 2)
        ###jwc n cv2.line(image, topRight, bottomRight, (0, 255, 0), 2)
        ###jwc n cv2.line(image, bottomRight, bottomLeft, (0, 255, 0), 2)
        ###jwc n cv2.line(image, bottomLeft, topLeft, (0, 255, 0), 2)
